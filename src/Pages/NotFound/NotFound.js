...
const NotFound = () => {
  return (
    <div>
      <h1 className="text-green-500 text-center text-6xl  my-20 lg:text-9xl font-bold">Oppps!!</h1>
      ...
      <Link to="/" className="btn text-black bg-gradient-to-r from-green-900 to-green-100 mt-4 ">
              BACK TO HOME
            </Link>
            </p>
    </div>
